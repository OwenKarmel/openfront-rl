...
class VecEnv:
    ...
    def step(
        ...
        """actions: (n, 3) int array -- [action_type_idx, macro_tile_idx,
        player_idx] per env (see OpenFrontEnv.action_space). Auto-resets any
        env that just terminated/truncated.
